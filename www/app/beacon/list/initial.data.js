(function() {
	...
	angular
		...
		.controller('ListInitialData', ListInitialData);

	ListInitialData.$inject = ['$q', 'GameType', 'Mission', 'Level', 'Checkpoint', 'Platform', 'Region', 'Mic', 'Resource', 'UI'];

	function ListInitialData($q, GameType, Mission, Level, Checkpoint, Platform, Region, Mic, Resource, UI) {
		return function() {
